...
Peer dependency: `@blockrun/clawrouter` `>=0.12.275 <0.13.0`. The free canary was last proven on 0.12.267; the paid canary was last proven on 0.12.249. The tool never forks or patches ClawRouter — it drives the published library.
